...
<%@include file="/WEB-INF/views/template/header.jsp" %>
 ...
 <div class="container-wrapper">
	...
	<div class=" col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 sol-sm-offset-1 col-md-offset-3">		
		...
		<div class="row">
			<div class="col-xs-6 col-sm-6 col-md-6">
				<address>
					...
					${order.cart.customer.shippingAddress.couontry}, ${order.cart.customer.shippingAddress.zipCode} <br>
		...
		<div class="row">
			<div class="col-xs-6 col-sm-6 col-md-6">
				<address>
					...
					${order.cart.customer.billingAddress.couontry}, ${order.cart.customer.billingAddress.zipCode} <br>
			...
			<table class="table table-hover">
				...
				<c:forEach var="cartItem" items="${order.cart.cartItems}" >
					<tr>
						...
						<td class="col-md-9"><em>${cartItem.product.price}</em></td>
